	...
	<div class="row">
		<div class="col-lg-12">
			<div class="page-header">
				<h1><i class="fa fa-money"></i> Relatório de NÃO Pagantes</h1>
			</div>
...
<script type="text/javascript">
	...
	$('#eventsTable').DataTable({
		"ajax": "<?=base_url('index.php/reports/debtorsEventUsers');?>",
	...
	$('#shortcoursesTable').DataTable({
		"ajax": "<?=base_url('index.php/reports/debtorsShortcoursesUsers');?>",
		"language":{"url": "//cdn.datatables.net/plug-ins/9dcbecd42ad/i18n/Portuguese-Brasil.json"},
		"columns": [
			{ "data": "idUser" },
			{ "data": "user" },
